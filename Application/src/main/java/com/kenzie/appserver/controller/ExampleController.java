...
//        exampleResponse.setId(example.getEventId());
//        exampleResponse.setName(example.getCustomerName());
...
//        Event example = exampleService.addNewExample(exampleCreateRequest.getName());
//
//        ExampleResponse exampleResponse = new ExampleResponse();
//        exampleResponse.setId(example.getEventId());
//        exampleResponse.setName(example.getCustomerName());
